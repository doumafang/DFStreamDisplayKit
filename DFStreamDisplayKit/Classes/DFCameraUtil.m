...
#import "DFCameraUtil.h"
#import "GPUImage.h"
#import "DFResolutionUtil.h"

@implementation DFCameraUtil
...
+ (CGPoint)captureDevicePointOfInterestForPoint:(CGPoint)point inPreview:(GPUImageView *)previewView withVideoCamera:(GPUImageVideoCamera *)videoCamera {
  ...
  float videoWidthPixels = [DFResolutionUtil videoWidth:sessionPreset];
  float videoHeightPixels = [DFResolutionUtil videoHeight:sessionPreset];
